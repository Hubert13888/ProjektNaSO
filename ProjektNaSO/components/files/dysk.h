...
public:
	...
	void usunPlik(string nazwa, string rozszerzenie, string nazwaFolderu); // funkcja zwalnia bloki, czy�ci wpis na dysku
	void utworzFolder(string nazwa, string nazwaNadrzednego); // funkcja tworzy folder podrz�dny w danym folderze 
...
private:
	...
	array<bool, 32> wektorBitowy; // tablica mowiaza to dostepomnosci miejsca na bloku dyskowym ->1 Blok wolny, 0 Blok zaj�ty
	...
	short znajdzPlik(string nazwa, string rozszerzenie); // funkcja zwraca numer i-wez�a w kt�rym znajduje si� plik, je�li plik nie istenieje -1
	short znajdzWolnyBlok(); // funkcja zwracajca numer pierwszego wolnego bloku na dysku, je�li brak zwraca -1
	short znajdzIwezel(); // funkcja zwracajaca numer pierwszego wolnego i-w�z�a, je�li brak zwraca -1
